...
| --- | --- | --- | --- | --- | --- | --- |
| NVIDIA driver package | `nvidia-driver-580-server-open=580.178.04-0ubuntu0.24.04.1` | Ubuntu 24.04 `linux/amd64` | [Ubuntu noble-updates open kernel metapackage](https://packages.ubuntu.com/noble-updates/amd64/nvidia-driver-580-server-open) | 2026-09-15 | Official `noble-updates` package metadata; sibling 580-server packages match this version | Exact installed version, Dual MIT/GPL open module license (not proprietary `nvidia-driver-580-server`), one RTX PRO 6000 after reboot |
